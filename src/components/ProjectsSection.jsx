...
export default function ProjectsSection() {
    const { t } = useLanguage();
    const p = t.projects;
    const projects = projectMeta.map((meta, i) => ({ ...meta, ...p.list[i] }));
        ...
        <section id="projects" className="py-24 px-4 relative ">
            <div className="container mx-auto max-w-6xl">
                <FadeInOnScroll delay={0.2} direction="up" >
                    ...
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">
                            {p.heading} <span className="text-primary">{p.headingHighlight}</span>
                        </h2>
                                        ...
                                        <div className="flex items-center gap-6">
                                            {project.demoUrl && (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-sm font-medium">{p.liveDemo}</span>
                                                </a>
                                            )}
                                            <a
                ...
                <div className="text-center">
                    <a
                        className="main-button w-fit flex items-center mx-auto p-4"
                        href="https://github.com/MahmoudMa2002"
                        target="_blank"
                    >
                        <span className="me-2">{p.github}</span>
